...
export const FloatingDock = ({
    ...
    return (
       <div className="flex flex-col items-center">
            ...
            <div className='w-64 h-1 bg-gradient-to-r from-gray-500 to-transparent mb-3'></div>
            <FloatingDockDesktop
                items={items}
        ...
        <Link href={href}>
            ...
            >
                ...
                <motion.div
                    ...
                    className='flex items-center justify-center text-gray-50 dark:text-neutral-900'
                >
                    {icon}
                </motion.div>
            </motion.div>
